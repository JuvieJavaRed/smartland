<%-- 
    Document   : create_land
    Created on : Mar 19, 2020, 11:04:13 PM
    Author     : Dell 7
--%>
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="box box-info">
                                <div class="box-header">
                                    <h3 class="box-title">Assign Land</h3>
                                </div>
                                <div class="box-body">
                                <form action="${pageContext.request.contextPath}/ratesdeposit" method="post">
                                	 <!-- Color Picker -->
